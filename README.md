...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/free-uv-index` | `npm install @voxgig-sdk/free-uv-index` |
| Python | `voxgig-sdk-free-uv-index` | `pip install voxgig-sdk-free-uv-index` |
| PHP | `voxgig-sdk/free-uv-index` | `composer require voxgig-sdk/free-uv-index` |
| Golang | `github.com/voxgig-sdk/free-uv-index-sdk/go` | `go get github.com/voxgig-sdk/free-uv-index-sdk/go` |
| Ruby | `voxgig-sdk-free-uv-index` | `gem install voxgig-sdk-free-uv-index` |
| Lua | `voxgig-sdk-free-uv-index` | `luarocks install voxgig-sdk-free-uv-index` |
