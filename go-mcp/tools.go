...
type Args struct {
	Entity string         `json:"entity" jsonschema:"uvi"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FreeUvIndexSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-uv-index_list",
		Description: "List records from FreeUvIndex. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-uv-index_load",
		Description: "Load a single record from FreeUvIndex. " +
...
func runOp(client *sdk.FreeUvIndexSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreeUvIndexSDK, name string) (sdk.FreeUvIndexEntity, error) {
	switch strings.ToLower(name) {
	case "uvi":
		return client.Uvi(nil), nil
