...
#      offline in seeded test mode (FreeUvIndexSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FreeUvIndex_sdk.rb")
  SDK_CLASS = "FreeUvIndexSDK"
