...
// FreeUvIndex SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeUvIndexSDK::test)
...
{
    private const SDK_CLASS = 'FreeUvIndexSDK';
    ...
    private const SDK_BASE = 'freeuvindex_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../freeuvindex_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
