...
class UviDirectTest extends TestCase
{
    public function test_direct_list_uvi(): void
    {
        $setup = uvi_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-uvi", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
