...
// FreeUvIndex SDK streaming feature
...
class FreeUvIndexStreamingFeature extends FreeUvIndexBaseFeature
{
    ...
    private function _iterate(FreeUvIndexResult $result): \Generator
    {
    ...
    private function _streamable(FreeUvIndexContext $ctx): bool
    {
