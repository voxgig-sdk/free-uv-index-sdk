...
// FreeUvIndex SDK idempotency feature
...
class FreeUvIndexIdempotencyFeature extends FreeUvIndexBaseFeature
{
    ...
    private function _mutating(FreeUvIndexContext $ctx): bool
    {
