...
// FreeUvIndex SDK ratelimit feature
...
class FreeUvIndexRatelimitFeature extends FreeUvIndexBaseFeature
{
    ...
    private function _acquire(FreeUvIndexContext $ctx): void
    {
    ...
    private function _track(FreeUvIndexContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
