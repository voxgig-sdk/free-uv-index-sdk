...
// FreeUvIndex SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FreeUvIndexTestFeature extends FreeUvIndexBaseFeature
{
    ...
    public function init(FreeUvIndexContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FreeUvIndexContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FreeUvIndexParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FreeUvIndexContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FreeUvIndexContext $ctx, $op, $args): array
    {
