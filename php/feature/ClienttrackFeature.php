...
// FreeUvIndex SDK clienttrack feature
...
class FreeUvIndexClienttrackFeature extends FreeUvIndexBaseFeature
{
    ...
    public function PostConstruct(FreeUvIndexContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeUvIndex-SDK';
