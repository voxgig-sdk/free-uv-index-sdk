...
class FreeUvIndexCacheFeature extends FreeUvIndexBaseFeature
{
    ...
    private function _through(FreeUvIndexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
