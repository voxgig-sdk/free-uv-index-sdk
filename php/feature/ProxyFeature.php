...
class FreeUvIndexProxyFeature extends FreeUvIndexBaseFeature
{
    ...
    public function init(FreeUvIndexContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeUvIndexContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
