...
// FreeUvIndex SDK netsim feature
...
class FreeUvIndexNetsimFeature extends FreeUvIndexBaseFeature
{
    ...
    private function _simulate(FreeUvIndexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FreeUvIndexContext $ctx, array $applied): void
    {
        $client = $this->client;
