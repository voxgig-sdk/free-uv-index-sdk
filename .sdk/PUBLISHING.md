...
|---|---|---|
| `ts/` | @voxgig-sdk/free-uv-index-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/free-uv-index-sdk \
      --repository voxgig-sdk/free-uv-index-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/free-uv-index-sdk` shows it, and
`npm trust revoke @voxgig-sdk/free-uv-index-sdk --id=<id>` removes it.
