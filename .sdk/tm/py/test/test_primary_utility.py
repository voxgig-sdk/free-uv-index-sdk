...
from projectname_sdk import FreeUvIndexSDK
from projectname_sdk.core.spec import FreeUvIndexSpec
from projectname_sdk.core.result import FreeUvIndexResult
from projectname_sdk.core.response import FreeUvIndexResponse
from projectname_sdk.core.operation import FreeUvIndexOperation
from projectname_sdk.core.error import FreeUvIndexError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FreeUvIndexBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return FreeUvIndexError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FreeUvIndexSDK.test(None, None)
        ...
        class TestInitFeature(FreeUvIndexBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FreeUvIndexBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FreeUvIndexSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FreeUvIndexSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = FreeUvIndexOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FreeUvIndexSDK.test(None, setup_opts)
