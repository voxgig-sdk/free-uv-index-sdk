...
from projectname_sdk.core.control import FreeUvIndexControl
...
class FreeUvIndexContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FreeUvIndexSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FreeUvIndexResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeUvIndexResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FreeUvIndexError(code, msg, self)
