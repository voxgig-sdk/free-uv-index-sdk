...
class FreeUvIndexRbacFeature extends FreeUvIndexBaseFeature
{
    ...
    private function _required(FreeUvIndexContext $ctx): ?string
    {
    ...
    private function _reject(FreeUvIndexContext $ctx, string $required): void
    {
    ...
    private function _track(FreeUvIndexContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
