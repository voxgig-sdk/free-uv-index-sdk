...
// FreeUvIndex SDK timeout feature
...
class FreeUvIndexTimeoutFeature extends FreeUvIndexBaseFeature
{
    ...
    private function _with_timeout(FreeUvIndexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeUvIndexContext $_ctx, float $ms): void
    {
        $client = $this->client;
