...
// FreeUvIndex SDK metrics feature
...
class FreeUvIndexMetricsFeature extends FreeUvIndexBaseFeature
{
    ...
    private function _record(FreeUvIndexContext $ctx, bool $ok): void
    {
