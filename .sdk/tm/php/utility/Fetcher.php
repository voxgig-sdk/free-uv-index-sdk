...
// FreeUvIndex SDK utility: fetcher

class FreeUvIndexFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeUvIndexSDK/1.0)';
    ...
    public static function call(FreeUvIndexContext $ctx, string $fullurl, array $fetchdef): array
    {
