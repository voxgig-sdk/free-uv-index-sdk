...
// FreeUvIndex SDK utility: graphql
//
...
class FreeUvIndexGraphql
{
    ...
    // equivalent.
    public static function body(FreeUvIndexContext $ctx): mixed
    {
    ...
    public static function errors(FreeUvIndexContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
