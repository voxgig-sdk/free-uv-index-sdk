...
// FreeUvIndex SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FreeUvIndexMakeRequest
{
    public static function call(FreeUvIndexContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FreeUvIndexResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FreeUvIndexResponse($fetched);
        } else {
