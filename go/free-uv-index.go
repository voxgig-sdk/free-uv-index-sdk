...
// instead of `sdk.NewFreeUvIndexSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *FreeUvIndexSDK  { return NewFreeUvIndexSDK(nil) }
func Test() *FreeUvIndexSDK { return TestSDK(nil, nil) }
