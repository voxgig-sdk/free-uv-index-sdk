...
func (sdk *FreeUvIndexSDK) OptionsMap() map[string]any {
...
func (sdk *FreeUvIndexSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FreeUvIndexSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FreeUvIndexSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeUvIndexSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FreeUvIndexSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FreeUvIndexSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FreeUvIndexSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FreeUvIndexSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeUvIndexSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FreeUvIndexSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
