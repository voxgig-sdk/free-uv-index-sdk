...
func NewUviEntity(client *core.FreeUvIndexSDK, entopts map[string]any) *UviEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UviEntity) GetName() string { return e.name }
...
func (e *UviEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UviEntity) Deleted() bool {
	return e.deleted
}


func (e *UviEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUviEntity(e.client, opts)
}

func (e *UviEntity) Data(args ...any) any {
...
func (e *UviEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Uvi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UviEntity) DataTyped(data ...Uvi) Uvi {
	if len(data) > 0 {
		return typedFrom[Uvi](e.Data(asMap(data[0])))
	}
	return typedFrom[Uvi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Uvi (all fields
// optional at the wire level).
func (e *UviEntity) MatchTyped(match ...Uvi) Uvi {
	if len(match) > 0 {
		return typedFrom[Uvi](e.Match(asMap(match[0])))
	}
	return typedFrom[Uvi](e.Match())
}
...
func (e *UviEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UviEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *UviEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UviListMatch and returns []Uvi. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *UviEntity) ListTyped(reqmatch UviListMatch, ctrl map[string]any) ([]Uvi, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Uvi](res), nil
}



func (e *UviEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UviEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UviEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UviEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
