...
| --- | --- | --- | --- |
| Uvi | `list` | `GET /uvi` | See reference |

## Connect to the API

- API server: `https://currentuvindex.com/api/v1`
...
- `free-uv-index_list`: List records for an entity. Supported entities: `uvi`.
- `free-uv-index_load`: Load one record for an entity. No active entity supports this operation.
