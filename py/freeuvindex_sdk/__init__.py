...
from freeuvindex_sdk.utility import register

# Load features
from freeuvindex_sdk.feature.base_feature import FreeUvIndexBaseFeature
from freeuvindex_sdk.features import _has_feature, _make_feature
...
class FreeUvIndexSDK:
    ...
    def get_utility(self):
        return FreeUvIndexUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreeUvIndexSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Uvi(self, data=None) -> "UviEntity":
        ...
        from freeuvindex_sdk.entity.uvi_entity import UviEntity
