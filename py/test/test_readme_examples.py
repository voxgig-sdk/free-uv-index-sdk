# FreeUvIndex SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeUvIndexSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeUvIndexSDK(...) and FreeUvIndexSDK.test(...) become
#      FreeUvIndexSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freeuvindex_sdk"
_SDK_CLASS = "FreeUvIndexSDK"
