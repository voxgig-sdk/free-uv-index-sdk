...
class FreeUvIndexTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeUvIndexTestRunner.getenv("FREEUVINDEX_TEST_LIVE")
        override = FreeUvIndexTestRunner.getenv("FREEUVINDEX_TEST_OVERRIDE")
        ...
        explain = FreeUvIndexTestRunner.getenv("FREEUVINDEX_TEST_EXPLAIN")
