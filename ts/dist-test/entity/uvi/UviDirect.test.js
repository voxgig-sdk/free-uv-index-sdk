...
(0, node_test_1.describe)('UviDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FreeUvIndexSDK({
    ...
    (0, node_test_1.test)('direct-list-uvi', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-uvi', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            query.latitude = 40.6943;
            query.longitude = -73.9249;
        }
...
function liveScenariosActive() { return false && process.env.FREE_UV_INDEX_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FreeUvIndexSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FREE_UV_INDEX_TEST_UVI_ENTID'];
    ...
    const client = new __1.FreeUvIndexSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=UviDirect.test.js.map