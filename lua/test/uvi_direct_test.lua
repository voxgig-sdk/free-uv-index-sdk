...
describe("UviDirect", function()
  it("should direct-list-uvi", function()
    local setup = uvi_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-uvi", setup.live and "live" or "unit")
...
function uvi_direct_setup(mockres)
