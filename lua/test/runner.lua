...
function runner.env_override(m)
  local live = runner.getenv("FREE_UV_INDEX_TEST_LIVE")
  local override = runner.getenv("FREE_UV_INDEX_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FREE_UV_INDEX_TEST_EXPLAIN")
