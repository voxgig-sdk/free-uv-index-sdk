...
function runner.env_override(m)
  local live = runner.getenv("FREEUVINDEX_TEST_LIVE")
  local override = runner.getenv("FREEUVINDEX_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FREEUVINDEX_TEST_EXPLAIN")
