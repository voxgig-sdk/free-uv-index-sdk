...
func registerSDKWords(r *eng.Registry, client *sdk.FreeUvIndexSDK) {
...
func runOp(client *sdk.FreeUvIndexSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
